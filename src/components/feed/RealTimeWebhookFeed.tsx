...
const SAMPLE: { kind: FeedKind; message: string }[] = [
  {
    kind: "released",
    message: "Squad transfer released · ₦142,000 → EMP-10042",
  },
  { kind: "paused", message: "AI paused payment · EMP-10118 · Risk 74" },
  {
    kind: "blocked",
    message: "Squad gate blocked · Shared Account ring detected",
  },
  {
    kind: "released",
    message: "Squad transfer released · ₦98,500 → EMP-10067",
  },
