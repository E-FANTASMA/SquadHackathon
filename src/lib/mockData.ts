...
export const RED_FLAGS: { name: FlagReason; description: string }[] = [
  {
    name: "Shared Account",
    description: "Multiple employees linked to one bank account.",
  },
  {
    name: "Payday Pop-up",
    description: "Account opened less than 48 hours before payroll.",
  },
  {
    name: "Ghost Jump",
    description: "Salary increase greater than 20% with no promotion record.",
  },
  {
    name: "Velocity Flag",
    description: "Duplicate payment to the same beneficiary in one cycle.",
  },
];
