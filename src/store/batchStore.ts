...
const SQUAD_ERRORS = [
  ...
  },
  {
    ...
    message: "Recipient account number could not be verified by NIBSS.",
  },
  {
    code: "SQUAD_TIMEOUT",
    message: "Squad gateway did not respond within 30s.",
  },
  {
    code: "DUPLICATE_REF",
    message: "Transaction reference already exists for this cycle.",
  },
];
