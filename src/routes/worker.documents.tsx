    ...
    return (
      <div className="mx-auto max-w-md px-4 py-10 text-center sm:max-w-xl">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          You need to match a payroll record before uploading documents.
        </p>
      ...
      <header className="mb-5 flex items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Upload your bank statement and a transaction screenshot.
          </p>
        </div>
      ...
      {locked && (
        ...
        >
          <div className="flex items-center gap-2 font-semibold">
            <Lock className="h-4 w-4" /> Uploads locked
          </div>
          <p className="mt-1">
            Your trust score is below 50. To unlock further uploads, please file an appeal with your
            administrator.
          </p>
          <Button asChild className="mt-3 w-full" variant="secondary">
            <Link to="/worker/appeal">Request appeal</Link>
          </Button>
        </div>
      )}
  ...
  return (
    ...
    >
      ...
      <span
        ...
        style={{
          color: file ? "var(--status-verified)" : "var(--muted-foreground)",
        }}
      >
