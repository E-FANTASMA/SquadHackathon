          ...
          {open.map((a) => (
            <AppealItem
              ...
              onApprove={(note) => {
                ...
                pushFeed({
                  kind: "override",
                  message: `Appeal approved · ${a.workerName}`,
                });
              ...
              onReject={(note) => {
                ...
                pushFeed({
                  kind: "blocked",
                  message: `Appeal rejected · ${a.workerName}`,
                });
            ...
            {closed.map((a) => (
              ...
              >
                ...
                <span
                  ...
                  style={{
                    color:
                      a.status === "approved" ? "var(--status-verified)" : "var(--status-rejected)",
